...
urlpatterns = [
    ...
    path('guestbook/deleteform/<int:guestbook_id>', guestbook_views.deleteform),
    path('guestbook/delete', guestbook_views.delete),

    path('board/list', board_views.list),

    path('board/modify/<int:board_id>', board_views.modify),
    path('board/update', board_views.update),
    path('board/view/<int:board_id>', board_views.view),

    path('board/writeform', board_views.writeform),
    path('board/write', board_views.write),
    path('board/delete/<int:board_id>', board_views.delete),
